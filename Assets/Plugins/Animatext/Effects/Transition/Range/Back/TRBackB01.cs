...
{
    [CreateAssetMenu(menuName = "Animatext Preset/Transition - Range/Back/Back - B01", fileName = "New TRBackB01 Preset", order = 369)]
    public sealed class TRBackB01 : DefaultTemplateEffect
    {
        ...
        protected override void Animate()
        {
            ...
            else
            {
                ...
                range.Scale(Vector2.LerpUnclamped(Vector2.one, scale, progressA), anchorPoint);
                range.Rotate(rotation * progressA, anchorPoint);
                range.Move(positionA * progressA + positionB * progress);
            }
        }
    }
}