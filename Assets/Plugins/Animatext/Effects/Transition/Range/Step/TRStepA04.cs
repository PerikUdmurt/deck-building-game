...
{
    [CreateAssetMenu(menuName = "Animatext Preset/Transition - Range/Step/Step - A04", fileName = "New TRStepA04 Preset", order = 369)]
    public sealed class TRStepA04 : DefaultTemplateEffect
    {
