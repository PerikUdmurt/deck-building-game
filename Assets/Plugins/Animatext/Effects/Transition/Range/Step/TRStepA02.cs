...
{
    [CreateAssetMenu(menuName = "Animatext Preset/Transition - Range/Step/Step - A02", fileName = "New TRStepA02 Preset", order = 369)]
    public sealed class TRStepA02 : DefaultTemplateEffect
    {
