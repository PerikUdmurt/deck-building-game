...
{
    [CreateAssetMenu(menuName = "Animatext Preset/Transition - Word/Elastic/Elastic - B05", fileName = "New TWElasticB05 Preset", order = 369)]
    public sealed class TWElasticB05 : DefaultTemplateEffect
    {
        ...
        protected override void Animate()
        {
            for (int i = 0; i < wordCount; i++)
            {
                ...
                else
                {
                    ...
                    words[i].Skew(skew * progress, anchorPoint);
                }
            }
        }
    }
