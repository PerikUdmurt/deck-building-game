...
{
    [CreateAssetMenu(menuName = "Animatext Preset/Transition - Character/Elastic/Elastic - B05", fileName = "New TCElasticB05 Preset", order = 369)]
    public sealed class TCElasticB05 : DefaultTemplateEffect
    {
        ...
        protected override void Animate()
        {
            for (int i = 0; i < characterCount; i++)
            {
                ...
                else
                {
                    ...
                    characters[i].Skew(skew * progress, anchorPoint);
                }
            }
        }
    }
