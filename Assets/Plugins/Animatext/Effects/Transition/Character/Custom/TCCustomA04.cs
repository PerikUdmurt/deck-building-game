...
{
    [CreateAssetMenu(menuName = "Animatext Preset/Transition - Character/Custom/Custom - A04", fileName = "New TCCustomA04 Preset", order = 369)]
    public sealed class TCCustomA04 : DefaultTemplateEffect
    {
