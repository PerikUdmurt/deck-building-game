...
{
    [CreateAssetMenu(menuName = "Animatext Preset/Transition - Character/Bounce/Bounce - B01", fileName = "New TCBounceB01 Preset", order = 369)]
    public sealed class TCBounceB01 : DefaultTemplateEffect
    {
