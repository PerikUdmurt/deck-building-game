...
{
    [CreateAssetMenu(menuName = "Animatext Preset/Transition - Character/Back/Back - B02", fileName = "New TCBackB02 Preset", order = 369)]
    public sealed class TCBackB02 : DefaultTemplateEffect
    {
        ...
        protected override void Animate()
        {
            for (int i = 0; i < characterCount; i++)
            {
                ...
                else
                {
                    ...
                    characters[i].Rotate(rotation * progressA, anchorPoint);
