...
{
    [CreateAssetMenu(menuName = "Animatext Preset/Coherence - Word/Elastic/Elastic - B02", fileName = "New CWElasticB02 Preset", order = 369)]
    public sealed class CWElasticB02 : DefaultTemplateEffect
    {
        ...
        protected override void Animate()
        {
            for (int i = 0; i < wordCount; i++)
            {
                ...
                words[i].Rotate(Mathf.LerpUnclamped(startRotation, rotation, progressA), anchorPoint);
