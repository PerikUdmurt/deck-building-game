...
{
    [CreateAssetMenu(menuName = "Animatext Preset/Coherence - Line/Elastic/Elastic - B05", fileName = "New CLElasticB05 Preset", order = 369)]
    public sealed class CLElasticB05 : DefaultTemplateEffect
    {
