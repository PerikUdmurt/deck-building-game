...
{
    public class CBounceA02Script : BaseEffectScript
    {
        private void Start()
        {
            CCBounceA02 a1 = ScriptableObject.CreateInstance<CCBounceA02>();
            ...
            CCBounceA02 a2 = ScriptableObject.CreateInstance<CCBounceA02>();
            ...
            CCBounceA02 a3 = ScriptableObject.CreateInstance<CCBounceA02>();
            ...
            CCBounceA02 a4 = ScriptableObject.CreateInstance<CCBounceA02>();
            ...
            CWBounceA02 b1 = ScriptableObject.CreateInstance<CWBounceA02>();
            ...
            CWBounceA02 b2 = ScriptableObject.CreateInstance<CWBounceA02>();
            ...
            CWBounceA02 b3 = ScriptableObject.CreateInstance<CWBounceA02>();
            ...
            CWBounceA02 b4 = ScriptableObject.CreateInstance<CWBounceA02>();
            ...
            CLBounceA02 c1 = ScriptableObject.CreateInstance<CLBounceA02>();
            ...
            CLBounceA02 c2 = ScriptableObject.CreateInstance<CLBounceA02>();
            ...
            CLBounceA02 c3 = ScriptableObject.CreateInstance<CLBounceA02>();
            ...
            CLBounceA02 c4 = ScriptableObject.CreateInstance<CLBounceA02>();
            ...
            CGBounceA02 d1 = ScriptableObject.CreateInstance<CGBounceA02>();
            ...
            CGBounceA02 d2 = ScriptableObject.CreateInstance<CGBounceA02>();
            ...
            CGBounceA02 d3 = ScriptableObject.CreateInstance<CGBounceA02>();
            ...
            CGBounceA02 d4 = ScriptableObject.CreateInstance<CGBounceA02>();
