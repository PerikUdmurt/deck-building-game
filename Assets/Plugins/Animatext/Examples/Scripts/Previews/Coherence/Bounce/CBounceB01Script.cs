...
{
    public class CBounceB01Script : BaseEffectScript
    {
        private void Start()
        {
            CCBounceB01 a1 = ScriptableObject.CreateInstance<CCBounceB01>();
            ...
            CCBounceB01 a2 = ScriptableObject.CreateInstance<CCBounceB01>();
            ...
            CCBounceB01 a3 = ScriptableObject.CreateInstance<CCBounceB01>();
            ...
            CCBounceB01 a4 = ScriptableObject.CreateInstance<CCBounceB01>();
            ...
            CWBounceB01 b1 = ScriptableObject.CreateInstance<CWBounceB01>();
            ...
            CWBounceB01 b2 = ScriptableObject.CreateInstance<CWBounceB01>();
            ...
            CWBounceB01 b3 = ScriptableObject.CreateInstance<CWBounceB01>();
            ...
            CWBounceB01 b4 = ScriptableObject.CreateInstance<CWBounceB01>();
            ...
            CLBounceB01 c1 = ScriptableObject.CreateInstance<CLBounceB01>();
            ...
            CLBounceB01 c2 = ScriptableObject.CreateInstance<CLBounceB01>();
            ...
            CLBounceB01 c3 = ScriptableObject.CreateInstance<CLBounceB01>();
            ...
            CLBounceB01 c4 = ScriptableObject.CreateInstance<CLBounceB01>();
            ...
            CGBounceB01 d1 = ScriptableObject.CreateInstance<CGBounceB01>();
            ...
            d1.positionA = new Vector2(0, 45);
            d1.positionB = new Vector2(45, 0);
            d1.rotation = 90;
            ...
            CGBounceB01 d2 = ScriptableObject.CreateInstance<CGBounceB01>();
            ...
            d2.positionA = new Vector2(0, 45);
            d2.positionB = new Vector2(45, 0);
            d2.rotation = 90;
            ...
            CGBounceB01 d3 = ScriptableObject.CreateInstance<CGBounceB01>();
            ...
            CGBounceB01 d4 = ScriptableObject.CreateInstance<CGBounceB01>();
