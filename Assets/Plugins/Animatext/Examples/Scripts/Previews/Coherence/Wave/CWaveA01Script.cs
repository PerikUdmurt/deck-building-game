...
{
    public class CWaveA01Script : BaseEffectScript
    {
        private void Start()
        {
            CCWaveA01 a1 = ScriptableObject.CreateInstance<CCWaveA01>();
            ...
            CCWaveA01 a2 = ScriptableObject.CreateInstance<CCWaveA01>();
            ...
            CCWaveA01 a3 = ScriptableObject.CreateInstance<CCWaveA01>();
            ...
            a3.position = new Vector2(0, 15);
            a3.waves = 2;
            a3.easingType = EasingType.Linear;

            presetsA3 = new BaseEffect[] { a3 };

            CCWaveA01 a4 = ScriptableObject.CreateInstance<CCWaveA01>();
            ...
            a4.position = new Vector2(0, 15);
            a4.waves = 2;
            a4.easingType = EasingType.Linear;

            presetsA4 = new BaseEffect[] { a4 };

            CWWaveA01 b1 = ScriptableObject.CreateInstance<CWWaveA01>();
            ...
            b1.position = new Vector2(6, 9);
            b1.waves = 1;
            b1.easingType = EasingType.Linear;

            presetsB1 = new BaseEffect[] { b1 };

            CWWaveA01 b2 = ScriptableObject.CreateInstance<CWWaveA01>();
            ...
            b2.position = new Vector2(6, 9);
            b2.waves = 1;
            b2.easingType = EasingType.Linear;

            presetsB2 = new BaseEffect[] { b2 };

            CWWaveA01 b3 = ScriptableObject.CreateInstance<CWWaveA01>();
            ...
            b3.position = new Vector2(-6, 9);
            b3.waves = 2;
            b3.easingType = EasingType.Linear;

            presetsB3 = new BaseEffect[] { b3 };

            CWWaveA01 b4 = ScriptableObject.CreateInstance<CWWaveA01>();
            ...
            b4.position = new Vector2(-6, 9);
            b4.waves = 2;
            b4.easingType = EasingType.Linear;

            presetsB4 = new BaseEffect[] { b4 };

            CLWaveA01 c1 = ScriptableObject.CreateInstance<CLWaveA01>();
            ...
            c1.position = new Vector2(-6, -9);
            c1.waves = 1;
            c1.easingType = EasingType.Linear;

            presetsC1 = new BaseEffect[] { c1 };

            CLWaveA01 c2 = ScriptableObject.CreateInstance<CLWaveA01>();
            ...
            c2.position = new Vector2(-6, -9);
            c2.waves = 1;
            c2.easingType = EasingType.Linear;

            presetsC2 = new BaseEffect[] { c2 };

            CLWaveA01 c3 = ScriptableObject.CreateInstance<CLWaveA01>();
            ...
            c3.position = new Vector2(-6, 9);
            c3.waves = 2;
            c3.easingType = EasingType.Linear;

            presetsC3 = new BaseEffect[] { c3 };

            CLWaveA01 c4 = ScriptableObject.CreateInstance<CLWaveA01>();
            ...
            c4.position = new Vector2(-6, 9);
            c4.waves = 2;
            c4.easingType = EasingType.Linear;

            presetsC4 = new BaseEffect[] { c4 };

            CGWaveA01 d1 = ScriptableObject.CreateInstance<CGWaveA01>();
            ...
            d1.position = new Vector2(0, 15);
            d1.waves = 1;
            d1.easingType = EasingType.Linear;

            presetsD1 = new BaseEffect[] { d1 };

            CGWaveA01 d2 = ScriptableObject.CreateInstance<CGWaveA01>();
            ...
            d2.position = new Vector2(0, 15);
            d2.waves = 1;
            d2.easingType = EasingType.Linear;

            presetsD2 = new BaseEffect[] { d2 };

            CGWaveA01 d3 = ScriptableObject.CreateInstance<CGWaveA01>();
            ...
            d3.position = new Vector2(0, 15);
            d3.waves = 2;
            d3.easingType = EasingType.Linear;

            presetsD3 = new BaseEffect[] { d3 };

            CGWaveA01 d4 = ScriptableObject.CreateInstance<CGWaveA01>();
