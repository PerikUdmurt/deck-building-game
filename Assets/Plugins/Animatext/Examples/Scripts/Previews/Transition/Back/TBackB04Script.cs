...
{
    public class TBackB04Script : BaseEffectScript
    {
        private void Start()
        {
            TCBackB04 a1 = ScriptableObject.CreateInstance<TCBackB04>();
            ...
            TCBackB04 a2 = ScriptableObject.CreateInstance<TCBackB04>();
            ...
            TCBackB04 a3 = ScriptableObject.CreateInstance<TCBackB04>();
            ...
            TCBackB04 a4 = ScriptableObject.CreateInstance<TCBackB04>();
            ...
            TWBackB04 b1 = ScriptableObject.CreateInstance<TWBackB04>();
            ...
            TWBackB04 b2 = ScriptableObject.CreateInstance<TWBackB04>();
            ...
            TWBackB04 b3 = ScriptableObject.CreateInstance<TWBackB04>();
            ...
            TWBackB04 b4 = ScriptableObject.CreateInstance<TWBackB04>();
            ...
            TLBackB04 c1 = ScriptableObject.CreateInstance<TLBackB04>();
            ...
            TLBackB04 c2 = ScriptableObject.CreateInstance<TLBackB04>();
            ...
            TLBackB04 c3 = ScriptableObject.CreateInstance<TLBackB04>();
            ...
            TLBackB04 c4 = ScriptableObject.CreateInstance<TLBackB04>();
            ...
            TGBackB04 d1 = ScriptableObject.CreateInstance<TGBackB04>();
            ...
            TGBackB04 d2 = ScriptableObject.CreateInstance<TGBackB04>();
            ...
            TGBackB04 d3 = ScriptableObject.CreateInstance<TGBackB04>();
            ...
            TGBackB04 d4 = ScriptableObject.CreateInstance<TGBackB04>();
