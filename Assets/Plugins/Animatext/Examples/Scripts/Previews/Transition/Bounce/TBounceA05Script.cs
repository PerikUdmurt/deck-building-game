...
{
    public class TBounceA05Script : BaseEffectScript
    {
        private void Start()
        {
            TCBounceA05 a1 = ScriptableObject.CreateInstance<TCBounceA05>();
            ...
            TCBounceA05 a2 = ScriptableObject.CreateInstance<TCBounceA05>();
            ...
            TCBounceA05 a3 = ScriptableObject.CreateInstance<TCBounceA05>();
            ...
            TCBounceA05 a4 = ScriptableObject.CreateInstance<TCBounceA05>();
            ...
            TWBounceA05 b1 = ScriptableObject.CreateInstance<TWBounceA05>();
            ...
            TWBounceA05 b2 = ScriptableObject.CreateInstance<TWBounceA05>();
            ...
            TWBounceA05 b3 = ScriptableObject.CreateInstance<TWBounceA05>();
            ...
            TWBounceA05 b4 = ScriptableObject.CreateInstance<TWBounceA05>();
            ...
            TLBounceA05 c1 = ScriptableObject.CreateInstance<TLBounceA05>();
            ...
            TLBounceA05 c2 = ScriptableObject.CreateInstance<TLBounceA05>();
            ...
            TLBounceA05 c3 = ScriptableObject.CreateInstance<TLBounceA05>();
            ...
            TLBounceA05 c4 = ScriptableObject.CreateInstance<TLBounceA05>();
            ...
            TGBounceA05 d1 = ScriptableObject.CreateInstance<TGBounceA05>();
            ...
            TGBounceA05 d2 = ScriptableObject.CreateInstance<TGBounceA05>();
            ...
            TGBounceA05 d3 = ScriptableObject.CreateInstance<TGBounceA05>();
            ...
            TGBounceA05 d4 = ScriptableObject.CreateInstance<TGBounceA05>();
